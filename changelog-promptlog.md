...
- The site is static HTML/CSS/JS generated by `generate-investment-art.mjs`.
...
- Generated pages remain maintainable through `generate-investment-art.mjs`.
...
- Consider a static JSON manifest instead of inline generator manifest.
