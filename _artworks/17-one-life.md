...
description_ai_v2: |
  **One Life** enlarges conception into a cosmic event, sending sperm-like forms toward a green cellular planet fused with Earth. Biology, code, fire and space all collide around the instruction: make use of it.

  As investment art, it carries keywords naturally: life art, motivational canvas, cosmic biology, DNA-inspired futurism and surreal banknote design. It is direct enough for a wall and weird enough to keep revealing details.

  The message is not gentle. Existence is rare, time is finite, and the artwork turns that fact into a bright, almost aggressive reminder.
---
